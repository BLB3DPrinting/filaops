/**
 * Navigation glyphs for the admin shell.
 *
 * Extracted verbatim from AdminLayout.jsx, which exceeded the 800-line
 * frontend limit in AGENT_POLICY. No paths were changed in the move.
 */

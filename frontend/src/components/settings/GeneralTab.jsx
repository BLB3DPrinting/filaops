/**
 * GeneralTab — extracted form body from AdminSettings.jsx.
 *
 * Receives all state and handlers as props from AdminSettings so the
 * parent retains single ownership of form state, API calls, and effects.
 * checkingManually state lives here (not a prop) — it is UI-only.
 * toast is instantiated here — not passed as a prop.
 */
import React, { useRef, useState } from "react";
import { useToast } from "../Toast";
import { useVersionCheck } from "../../hooks/useVersionCheck";
import { formatVersion } from "../../utils/version";
import { timezoneOptions, formatPhoneNumber } from "./constants";
import { currencyOptions, localeOptions } from "./i18nConstants";
import { API_URL } from "../../config/api";
import AiSettingsSection from "./AiSettingsSection";

export default function GeneralTab({
  // Settings object (raw, from API)
  settings,
  // Form state
  form,
  setForm,
    ...
    <form onSubmit={handleSave} className="space-y-6">
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        <div className="mt-4">
          ...
          />
          <p className="text-sm text-gray-400 mt-1">
            0=Monday, 1=Tuesday, ..., 6=Sunday. Example: &ldquo;0,1,2,3,4&rdquo; for Mon-Fri
          </p>
        </div>
      </div>

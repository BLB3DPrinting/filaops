...
DEBT-1 D1-A mechanical split: fulfillment, material-requirements, and
production-order generation moved verbatim to
sales_order_fulfillment_service.py, sales_order_requirements_service.py, and
sales_order_production_service.py (shared primitives in
sales_order_shared.py).  Every name this module previously exposed is
...
# ---------------------------------------------------------------------------
# DEBT-1 D1-A mechanical split: the names below moved verbatim to focused
# modules and are re-exported here so every pre-split import keeps working.
# ---------------------------------------------------------------------------
from app.services.sales_order_shared import (
    get_sales_order,
    get_sales_order_with_lines,  # noqa: F401
    record_order_event,
)
from app.services.sales_order_fulfillment_service import (
    _MATERIAL_SHIPMENT_GL_UNSUPPORTED_MESSAGE,  # noqa: F401
    _NEGATIVE_SHIPMENT_ADJUSTMENT_TYPE,  # noqa: F401
    _SHIPMENT_COST_ACCOUNTS,  # noqa: F401
...
from app.services.sales_order_requirements_service import (
    TERMINAL_ORDER_STATUSES,  # noqa: F401
    get_material_requirements,  # noqa: F401
    get_required_orders_for_sales_order,  # noqa: F401
)
from app.services.sales_order_production_service import (
    copy_routing_to_operations,
    create_production_orders_for_sales_order,  # noqa: F401
    generate_production_order_code,
    generate_production_orders,  # noqa: F401
)

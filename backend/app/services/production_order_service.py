...
# =============================================================================
# Backward-compat re-exports (DEBT-1 D2-A mechanical split)
# =============================================================================
# release_production_order + its release-only self-heal helpers moved to
# production_order_release_service.py; the start/complete/accept-short/split
# lifecycle transitions moved to production_order_execution_service.py.
# These imports keep the full public surface importable from this module so
# existing callers (endpoints, sales_order_*, dispatch_service, inventory_service,
# tests) continue to work unchanged. Placed at module end so this module finishes
# defining its own names before the submodules import them back.
from app.services.production_order_release_service import (  # noqa: E402,F401
    _has_active_reservation,
    _maybe_backfill_op_material_allocation,
    _maybe_reserve_missing_materials,
    release_production_order,
)
from app.services.production_order_execution_service import (  # noqa: E402,F401
